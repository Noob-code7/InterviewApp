    ...
    <div className="bg-[#F6F5F0] text-[#111110] min-h-screen font-sans">
          ...
          <div className="bg-[#111110] text-[#F0EEE8] border border-[#2A2A28] rounded-2xl p-8 relative overflow-hidden shadow-xl">
            ...
            <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <span className="px-2.5 py-0.5 rounded-full text-[10px] font-mono uppercase tracking-widest bg-[#1D5DFF] text-white font-semibold">
                    Authenticated Telemetry Hub
                  </span>
                  {user?.role && (
                ...
                <p className="text-sm text-[#9A9990] max-w-md mt-1 font-inter">
                  Select an interview mode to launch your next session or inspect your historical multimodal reports.
                </p>
              </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mt-8 pt-6 border-t border-[#2A2A28]">
              <div className="bg-[#161615] border border-[#2A2A28] rounded-xl p-4">
                <span className="text-[10px] font-mono uppercase text-[#6E6D68] tracking-widest block mb-1">
      ...
      <section id="product" className={`${isAuthenticated ? 'pt-4 pb-16' : 'pt-28 pb-20'} max-w-6xl mx-auto px-6`}>
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            <div className="font-mono text-[11px] tracking-[0.2em] uppercase text-[#6E6D68] mb-6 font-medium">
              Real-time AI interview simulator
            </div>
            <h1 className="text-5xl md:text-6xl font-bold leading-[1.05] tracking-tight mb-6" style={{ letterSpacing: '-0.02em' }}>
              The interview<br />
              <em className="not-italic text-[#1D5DFF]">before</em> the<br />
              interview.
            </h1>
            <p className="text-[#6E6D68] text-lg leading-relaxed mb-10 max-w-md font-inter">
              Practice realistic interviews with an AI that listens to how you speak, what you say, and how you present yourself.
            </p>
      ...
      {isAuthenticated && stats?.recentSessions?.length > 0 && (
        <section className="py-16 max-w-6xl mx-auto px-6">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link to="/history" className="text-xs font-mono font-semibold text-[#1D5DFF] hover:underline">
              View All History →
            </Link>
          </div>
      ...
      <section id="how-it-works" className="py-24 max-w-6xl mx-auto px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="text-5xl md:text-6xl font-bold leading-tight mb-6 tracking-tight" style={{ letterSpacing: '-0.02em' }}>
              Not a chatbot.
              <br />
              An actual
              <br />
            ...
            <p className="text-[#6E6D68] text-base leading-relaxed max-w-md font-inter">
              InterviewAI simulates the structure, pressure, and follow-up dynamics of a real interview — not a question-answer loop. You respond verbally. It listens. Then it pushes back.
            </p>
          </div>
      ...
      <section id="features" className="py-24 bg-[#111110] text-[#F0EEE8]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-16">
            ...
            <h2 className="text-4xl md:text-5xl font-bold leading-tight tracking-tight" style={{ letterSpacing: '-0.02em' }}>
              It evaluates more<br />than your answer.
            </h2>
          </div>
        ...
        <div className="max-w-6xl mx-auto px-6">
          <div className="mb-12 flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div>
              ...
              <h2 className="text-4xl font-bold text-[#F0EEE8] tracking-tight" style={{ letterSpacing: '-0.02em' }}>
                The real experience.
              </h2>
            </div>
            <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 min-h-[360px]">
              ...
              <div className="col-span-2 p-8 border-r border-[#2A2A28] flex flex-col justify-between">
                ...
                <div className="flex items-center gap-3 mt-8">
                  ...
                  <button onClick={() => navigate(isAuthenticated ? '/interview/setup' : '/register')} className="ml-auto font-mono text-[10px] text-red-400 border border-red-900/40 rounded px-3 py-2 hover:border-red-600/40 transition-colors">
                    End interview
                  </button>
                </div>
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
          <div>
            ...
            <h2 className="text-4xl md:text-5xl font-bold tracking-tight mb-6" style={{ letterSpacing: '-0.02em' }}>
              Know exactly<br />what to improve.
            </h2>
            <p className="text-[#6E6D68] text-base leading-relaxed mb-8 max-w-sm font-inter">
              Every session generates a precise, actionable report — not vague encouragement. You'll know which dimension held you back and how to fix it.
            </p>
            <button
              onClick={() => navigate(isAuthenticated ? '/interview/setup' : '/register')}
      ...
      <section className="py-32 max-w-6xl mx-auto px-6 text-center">
        ...
        <h2 className="text-5xl md:text-6xl font-bold tracking-tight mb-6" style={{ letterSpacing: '-0.02em' }}>
          Your next interview<br />starts here.
        </h2>
        <p className="text-[#6E6D68] text-lg mb-10 max-w-md mx-auto font-inter">
          Practice under pressure. Understand your weaknesses. Walk into the real interview prepared.
        </p>
        <button
          onClick={() => navigate(isAuthenticated ? '/interview/setup' : '/register')}
      ...
      <footer className="border-t border-[#E0DFD9] bg-[#F6F5F0]">
        <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-xs text-[#9A9990] leading-relaxed font-inter">
