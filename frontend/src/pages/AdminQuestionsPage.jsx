    ...
    <div className="min-h-screen bg-[#F6F5F0] text-[#161615] p-6 lg:p-10">
      <div className="max-w-6xl mx-auto space-y-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 border-b border-[#E2DFD8] pb-6">
          <div>
            <h1 className="text-3xl font-bold text-[#161615] tracking-tight">
              Faculty & Admin — Question Bank Manager
            </h1>
            <p className="text-sm text-[#6E6D68] mt-1">
              Upload custom college question banks with explicit concept keywords. Student practice sessions will prioritize your uploaded questions!
            </p>
          </div>
        ...
        {activeTab === "single" ? (
          <Card className="bg-white border border-[#E2DFD8] rounded-2xl p-6 shadow-sm">
            ...
            <form onSubmit={onCreateSingle} className="space-y-4">
              ...
              <div>
                <label className="block text-xs font-semibold text-[#6E6D68] uppercase tracking-wider mb-1">
                  Reference Answer / Evaluation Guide (Optional)
                </label>
                <textarea
              ...
              <div>
                <label className="block text-xs font-semibold text-[#6E6D68] uppercase tracking-wider mb-1">
                  Target College Identifier (Leave blank for global)
                </label>
                <input
                  type="text"
                  value={form.college}
        ...
        <Card className="bg-white border border-[#E2DFD8] rounded-2xl p-6 shadow-sm space-y-4">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
            <h2 className="text-lg font-bold text-[#161615]">
              Active MongoDB Question Bank ({questions.length})
            </h2>
                ...
                <div key={q._id} className="py-4 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                  <div className="space-y-1.5 flex-1">
                    ...
                    <div className="flex flex-wrap items-center gap-2 text-xs text-[#6E6D68]">
                      <span className="px-2 py-0.5 rounded bg-[#FAF9F5] border border-[#E2DFD8] font-mono text-[10px]">
