...
const REFRESH_COOKIE_OPTIONS = {
  httpOnly: true,
  // Use secure + SameSite=None in production for cross-site cookies.
  // For local development we relax SameSite to 'lax' and keep secure=false
  secure: process.env.NODE_ENV === "production",
  sameSite: process.env.NODE_ENV === "production" ? "none" : "lax",
  maxAge: 7 * 24 * 60 * 60 * 1000, // 7 days in ms
  // Expose cookie across API paths so /api/auth/refresh and other routes can read it
  path: "/",
};
